...
public class FragmentAlbum extends Fragment {
    ...
    public void initViewAlbum() {
        RecyclerView recyclerViewAlbum = view.findViewById(R.id.rvAlbum);
        ...
        Cursor songCursor = contentResolver.query(albumUri, null, null, null, null);
        {
            if (songCursor != null && songCursor.moveToFirst()) {
                ...
                do {
                    ...
                    arrayListAlbum.add(new Album("",currentTitle,currentArtist,data));
